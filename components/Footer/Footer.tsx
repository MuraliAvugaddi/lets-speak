      ...
      <div className={styles.container}>
        ...
        <div className={styles.brandSection}>
          <div className={styles.logo}>
            ...
            <span className={styles.logoBlue}>Partner</span>
            <div className={styles.tagline}>The Language Hub</div>
          </div>
          ...
          <div className={styles.socialIcons}>
            ...
            <a href="#" className={`${styles.socialIcon} ${styles.medium}`}>
              <svg viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className={styles.linkSection}>
          ...
          <ul className={styles.linkList}>
            ...
            <li><a href="#">EP Reviews</a></li>
            <li><a href="#">Games</a></li>
            <li><a href="#">Communication insights</a></li>
          </ul>
        </div>
        ...
        <div className={styles.contactSection}>
          ...
          <div className={styles.contactInfo}>
            <div className={styles.contactItem}>
              ...
              <p>
                D.no 48-18-13/1, Second Floor, Sri Gayatri Infra, Near Rama Talkies,<br />
                Rama Talkies Main Road, Srinagar,<br />
            ...
            <div className={styles.contactItem}>
              ...
              <a href="mailto:connect@englishpartner.in">letspeak@gmail.com</a>
            </div>
          </div>
        </div>
      </div>
