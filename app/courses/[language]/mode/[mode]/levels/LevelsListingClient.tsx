...
export default function LevelsListingClient() {
    ...
    <section className={styles.english_section}>
      <div className={styles.english_container}>
        ...
        <p style={{ textAlign: "center", marginBottom: "4rem", color: "#666" }}>
          A structured 7-stage journey designed to transform you from a beginner
          to a confident communicator through guided daily practice.
        </p>
