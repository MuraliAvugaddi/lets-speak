...
export default function CourseStagePageClient() {
                ...
                <div className={styles.facultyContent}>
                  ...
                  <div className={styles.facultyInfo}>
                    ...
                    <p className={styles.facultyDescription}>
                      Your guide through this learning journey with years of experience in language
                      education and a proven track record of student success.
                    </p>
                    <button className={styles.facultyButton} onClick={handleFacultyClick}>
              ...
              {stageData.planner.map((item) => (
                <div
                  ...
                  className={`${styles.accordionItem} ${
                    openDay === item.day ? styles.accordionItemActive : ""
                  }`}
                >
                  <button
                  ...
                  >
                    ...
                    <div
                      className={`${styles.accordionIcon} ${
                        openDay === item.day ? styles.accordionIconOpen : ""
                      }`}
                    >
                  ...
                  <div
                    className={`${styles.accordionContent} ${
                      openDay === item.day ? styles.accordionContentOpen : ""
                    }`}
                  >
            ...
            <div className={styles.blocksGrid}>
              {stageData.blocks.map((block, index) => (
                <div key={block.id} className={styles.contentBlock}>
                  <div className={styles.blockNumber}>{String(index + 1).padStart(2, "0")}</div>
